...
final=[]
for num_steps in [350,450,500,600,1000,1500,2000,2500,3000,4000,5000,6000,7000]:
...
for i in final:
    ...
    error.append(sum(abs(exact-i))/len(i))
...
x=[350,450,500,600,1000,1500,2000,2500,3000,4000,5000,6000]


plt.xlabel("Time steps (log scale)")
plt.ylabel("Error (log scale)")
plt.plot(np.log(x),np.log(error[:-1]),label='error')
plt.plot(np.log(x),np.log([1/i for i in x])+2,label='1/x')
plt.plot(np.log(x),np.log([1/(i**2) for i in x])+7.87,label='1/x**2')
plt.legend()
